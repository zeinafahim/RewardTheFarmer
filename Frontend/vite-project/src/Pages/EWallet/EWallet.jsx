...
const EWallet = ({ user }) => {
  const transactions = [
    { type: 'Waste Reward', amount: 350, date: 'Today, 2:45 PM', icon: 'fa-leaf', color: 'emerald', status: 'Completed', id: '#WR-9921' },
    { type: 'Loan Disbursement', amount: 5000, date: 'Oct 22, 11:30 AM', icon: 'fa-hand-holding-dollar', color: 'blue', status: 'Completed', id: '#LD-8812' },
    { type: 'Withdrawal', amount: -200, date: 'Oct 20, 09:15 AM', icon: 'fa-arrow-up-right-from-square', color: 'rose', status: 'Completed', id: '#WD-7701' },
  ];
              ...
              <div className="card-top">
                <div className="balance-box">
                  ...
                  <div className="amount-row">
                    ...
                    <h2 className="amount">{user.walletBalance.toLocaleString(undefined, { minimumFractionDigits: 2 })}</h2>
                  </div>
                </div>
